document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", (e) => {
    ...
    const insideIcons = openDesktop?.contains(e.target) || openMobile?.contains(e.target);
    if (sidebar.classList.contains("active") && !insideSidebar && !insideIcons) closeSidebar();
  });
});
